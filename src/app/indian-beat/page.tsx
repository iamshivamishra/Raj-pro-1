...
const page = () => {
  ...
  <div className="product-name-info fade-in">
    <div className="text-content fade-in" style={{ position: "relative", bottom: "50px" }}>
...
<br />
 ...
 <div className="beat-pack-container fade-in">
  <h2 className="beat-pack-title">Experience 1 GB+ of Indian Beats — Premium Ready-to-Use Tracks</h2>
  
  <p className="beat-pack-description">
    The Indian Beat Pack delivers a carefully selected collection of finished beats inspired by India’s legendary musical styles and instruments. Every track is professionally produced, mixed, and mastered—just drag and drop into projects.
  </p>

  <h3 className="beat-pack-subtitle" style={{color: "#ae4c4c", textDecoration: "none"}}>What's Inside:</h3>
  <ul className="beat-pack-list">
    <li>5 premium, original beats (WAV/MP3)</li>
    <li>Genres include Hip Hop Type Beat, Indian Type Beat, Trap Type Beat, Bollywood, Chill, and Fusion</li>
    <li>Features Indian instruments: Sitar, Bansuri, Sarangi, Tabla, Shehnai, Harmonium, Dholak, and more</li>
    <li>Each beat labeled with BPM, key, and mood</li>
    <li>Ready for rappers, singers, and media projects—license and use instantly</li>
    <li>100% original, royalty-free</li>
    <li>Commercial Use – No copyright strikes, no stress</li>
    <li>Ready to use on Spotify, Apple Music, YouTube, and more</li>
  </ul>

  <p className="beat-pack-description">
    Designed for artists and creators who want the signature sound of India fused with contemporary genres, the Indian Beat Pack is perfect for standing out with authentic vibes and modern production.
  </p>
</div>
<br />
 <section className="features-container">
  <div className="feature-box">
    ...
    <div className="feature-back">
      ...
      <p><b>Pro. Quality</b><br />High-quality 24-bit WAV files, professionally mixed and mastered.</p>
    </div>
  </div>
  ...
  <div className="feature-box">
    ...
    <div className="feature-back">
      ...
      <p><b>Unlimited License</b><br />Full commercial rights to upload anywhere and monetize.</p>
    </div>
  </div>
  ...
  <div className="feature-box">
    ...
    <div className="feature-back">
      <span className="feature-icon">⚡</span>
      <p><b>Instant Download</b><br />Immediate access to all beats after successful payment.</p>
    </div>
  </div>
</section>
<br />
...
<div className="license-background-container">
      <div className="license-container">
        <h2 className="license-heading">
          <span className="license-icon" style={{color: "#ff512f"}}></span> <span className='tak'> Unlimited License Terms </span>
        </h2>

        <div className="license-row">
          {/* ✅ You CAN */}
          <div
            className="license-section can"
          >
          ...
          {/* ❌ You CANNOT */}
          <div
            className="license-section cannot"
          >
            <h3 className="license-subheading">
